...
class HotelsControllerTest < ActionController::TestCase
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post :create, hotel: { description: @hotel.description, latitude: @hotel.latitude, longitude: @hotel.longitude, name: @hotel.name }
    end
  ...
  test "should update hotel" do
    put :update, id: @hotel, hotel: { description: @hotel.description, latitude: @hotel.latitude, longitude: @hotel.longitude, name: @hotel.name }
    assert_redirected_to hotel_path(assigns(:hotel))
  end
