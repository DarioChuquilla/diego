class Admin::SpecialtiesController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @specialty.save
        format.html { redirect_to admin_specialty_path(@specialty), notice: 'Specialty was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @specialty.update_attributes(params[:specialty])
        format.html { redirect_to admin_specialty_path(@specialty), notice: 'Specialty was successfully updated.' }
